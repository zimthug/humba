...
describe('Service Tests', () => {
    describe('Meter Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MeterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/meters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Meter', () => {
                service.create(new Meter(null)).subscribe(received => {
            ...
            it('should update a Meter', () => {
                service.update(new Meter(123)).subscribe(received => {
