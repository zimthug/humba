...
export class MeterComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.meterService
            ...
            .subscribe(
                (res: HttpResponse<IMeter[]>) => this.paginateMeters(res.body, res.headers),
    ...
    trackId(index: number, item: IMeter) {
        return item.id;
    }
    ...
    private paginateMeters(data: IMeter[], headers: HttpHeaders) {
